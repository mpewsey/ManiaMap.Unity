...
{
    public class TestRoomLayout3DSample
    {
        private const string TestScene = "RoomLayout3DSample";
        private RoomLayout3DSample Sample { get; set; }

        [UnitySetUp]
        public IEnumerator SetUp()
        {
            yield return Addressables.LoadSceneAsync(TestScene);
            Sample = Object.FindAnyObjectByType<RoomLayout3DSample>();
